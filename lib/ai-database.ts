...
export const defaultSubscriptionCatalog: SubscriptionCatalogService[] = [
    ...
    plans: [
      {
        ...
        category: '無料総合',
        includes: ['GPT-5系の制限枠', 'GPT-5 mini無制限', '基本チャット機能'],
      ...
      },
      {
        ...
        name: 'Plus',
        monthlyCostUsd: 20,
        summary: '個人利用の標準プラン。高度な推論、画像生成、Deep Research、Codex利用、音声会話まで広く使う人向け。',
        category: '総合AI',
        includes: ['GPT-5系', '画像生成 (GPT Image)', '高度音声モード', 'Sora 動画生成', 'Deep Research'],
        bestFor: '文章・画像・動画・音声生成から高度な推論まで、万能に使い倒したい人',
        cautions: 'Sora は生成枠やキューに制限あり。',
        matrixX: ['general', 'coding', 'media', 'audio'],
        matrixY: 'mid',
      },
      {
        ...
        category: '高負荷AI',
        includes: ['Plusの5倍の利用枠', 'o1 pro mode等', '優先アクセス', 'Sora 優先', '高度音声モード'],
      ...
      },
      {
        ...
        name: 'Pro ($200)',
        monthlyCostUsd: 200,
        summary: '最大級の利用枠、Pro推論、Deep Research、エージェント、Codex、Sora無制限級を重く使う人向け。',
        category: '超高負荷AI',
        includes: ['Plusの20倍の利用枠', 'GPT-5 Pro', 'Sora 無制限級', '高度音声モード', '最優先キュー'],
    ...
    plans: [
      {
        ...
        name: 'Free',
        monthlyCostUsd: 0,
        summary: '無料でClaude Sonnetを試したい方向け。',
        category: '無料文章',
        includes: ['Claude Sonnet 制限枠', 'Artifactsお試し', '文章支援'],
      ...
      },
      {
        ...
        category: '文章・分析',
        includes: ['Claude Sonnet 4.5', '長文処理', 'Artifacts / Project機能', 'Claude Code'],
        bestFor: '長文の推敲・リライト、資料分析、高精度のコーディングを望む人',
        cautions: 'メッセージ送信数が一定時間ごとに制限される仕組みがあります。画像・動画・音声生成は提供されていません。',
    ...
    plans: [
      {
        ...
        name: 'Google AI Plus',
        monthlyCostUsd: 7.99,
        summary: 'Freeより多い利用枠とGoogle AI機能を軽めに使う入口プラン。Imagen画像生成や軽量音声機能も利用可。',
        category: 'Google連携',
        includes: ['Gemini上位モデル（制限あり）', 'Imagen画像生成', 'Googleアプリ連携', '音声対話'],
        bestFor: 'Google Workspace機能を中心に軽めにAIを使いたい人',
        cautions: '動画生成(Veo)などは上位プランで本格的に使えます。',
        matrixX: ['general', 'media', 'audio'],
        matrixY: 'low',
      },
      {
        ...
        summary: 'Gemini、Google Flow、NotebookLM、Imagen画像、Veo動画、Googleアプリ連携を広く使う標準プラン。',
        category: 'Google連携',
        includes: ['Gemini 2.5 Pro', 'Imagen画像生成', 'Veo動画生成', 'Gemini Live (音声)', 'Google One 2TB'],
        bestFor: 'Gmail, Google Workspace, Android環境でシームレスに文章/画像/動画/音声を使いたい人',
        cautions: '推論ロジックの好みは分かれます。Veoは生成枠あり。',
        matrixX: ['general', 'coding', 'media', 'audio'],
        matrixY: 'mid',
      },
      {
        ...
        summary: 'AI Proより高い利用上限、Imagen/Veoの優先キュー、先行機能を求める上位プラン。',
        category: 'Google連携',
        includes: ['高い利用上限', 'Veo3 優先', 'Project Mariner', '先行機能アクセス'],
        bestFor: 'AI Proの利用上限を超えるヘビーユーザー、Veoを継続的に使う制作者',
      ...
      },
      {
        ...
        summary: 'AI Pro比で最大級の利用枠、Veo動画生成、Geminiの先行機能を重く使う人向け。',
        category: 'Google連携',
        includes: ['最大級の利用枠', 'Veo 3 動画生成', 'Gemini Live 音声', '先行機能アクセス'],
    ...
    plans: [
      {
        ...
        name: 'Pro',
        monthlyCostUsd: 20,
        summary: '日常的な検索、Pro Search、ファイル利用、モデル選択を使いたい人向け。Aurora画像生成も含む。',
        category: '検索・調査',
        includes: ['AIネット検索', '複数モデル選択', 'Aurora画像生成', 'ファイル分析'],
        bestFor: '出典が明示されたリサーチ、ニュースや最新情報のまとめを重視する人',
        cautions: '文章制作や対話の深さは、特化型の他チャットAIに分があります。動画・音声生成は提供されません。',
        matrixX: ['general', 'media'],
        matrixY: 'mid',
        yearly: {
      ...
      },
      {
        ...
        name: 'Max',
        monthlyCostUsd: 200,
        summary: '最新モデルや新機能への高いアクセスを求める上位プラン。Pro機能に加えて高優先キュー。',
        category: '検索・調査',
        includes: ['最高速レスポンス', '新機能早期アクセス', '大量の検索クエリ', 'Aurora画像生成'],
        bestFor: '膨大なリサーチ業務を抱えるプロフェッショナル',
        cautions: '動画・音声生成は提供されません。コーディング特化用途には他サービスが優位です。',
        matrixX: ['general', 'media'],
        matrixY: 'premium',
      },
    ],
    ...
    plans: [
      {
        ...
        cautions: '日常の一般的な会話や画像/動画/音声生成には向きません。',
        matrixX: ['coding'],
        matrixY: 'low',
        yearly: {
          monthlyCostUsd: 8.33,
    ...
    plans: [
      {
        ...
        cautions: 'コード補助に特化しており、画像/動画/音声生成には対応しません。',
        matrixX: ['coding'],
        matrixY: 'mid',
        yearly: {
          monthlyCostUsd: 16,
  ...
  },
  {
    ...
    mark: 'RW',
    vibe: '動画',
    description: 'AI動画、画像、映像編集ワークフローをまとめて使いたい人向け。',
    ...
    plans: [
      ...
      },
      {
        ...
        category: '動画生成',
        includes: ['2250クレジット', 'Gen-3 / Gen-4 全機能', '高解像度書き出し'],
        bestFor: '日常的に動画生成を業務で利用するクリエイター',
        cautions: '本格的な長編制作にはまだ制限があります。文章・コード支援は提供されません。',
        matrixX: ['media'],
        matrixY: 'mid',
        yearly: {
          monthlyCostUsd: 28,
