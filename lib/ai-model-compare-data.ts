...
export const FALLBACK_AI_MODELS: AiModel[] = [
  ...
  },
  {
    ...
    costPerformance: scores({ image: 78 }),
  ...
  },
  {
    ...
    sourceUrl: 'https://artificialanalysis.ai/image/leaderboard/text-to-image',
    performance: scores({ image: 98 }),
    costPerformance: scores({ image: 85 }),
  ...
  },
  {
    ...
    sourceUrl: 'https://artificialanalysis.ai/image/leaderboard/text-to-image',
    performance: scores({ image: 96 }),
    costPerformance: scores({ image: 88 }),
  ...
  },
  {
    ...
    sourceUrl: 'https://artificialanalysis.ai/image/leaderboard/text-to-image',
    performance: scores({ image: 97 }),
    costPerformance: scores({ image: 82 }),
  ...
  },
  {
    ...
    sourceUrl: 'https://artificialanalysis.ai/image/leaderboard/text-to-image',
    performance: scores({ image: 92 }),
    costPerformance: scores({ image: 80 }),
  ...
  },
  {
    ...
    sourceUrl: 'https://artificialanalysis.ai/image/leaderboard/text-to-image',
    performance: scores({ image: 86 }),
    costPerformance: scores({ image: 98 }),
